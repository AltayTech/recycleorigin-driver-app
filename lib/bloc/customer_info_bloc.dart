...
import 'package:recycleorigindriver/bloc/customer_info_event.dart';
import 'package:recycleorigindriver/bloc/customer_info_state.dart';
import 'package:recycleorigindriver/models/city.dart';
import 'package:recycleorigindriver/models/customer.dart';
import 'package:recycleorigindriver/models/driver.dart';
import 'package:recycleorigindriver/models/province.dart';
import 'package:recycleorigindriver/models/shop.dart';
import 'package:recycleorigindriver/models/status.dart';
import 'package:recycleorigindriver/models/transaction.dart';
import 'package:recycleorigindriver/models/transaction_main.dart';
...
class CustomerInfoBloc extends Bloc<CustomerInfoEvent, CustomerInfoState> {
  ...
  CustomerInfoBloc() : super(CustomerInfoState.initial()) {
    ...
    on<CustomerInfoSearchTransactionItemsRequested>(
        _onSearchTransactionItems);
  ...
  set sPage(int value) =>
      add(CustomerInfoSearchParamsChanged(sPage: value));
  ...
  Future<void> _onGetCities(
    ...
    final url =
        Urls.rootUrl + Urls.provincesEndPoint + '${event.provinceId}';
    try {
      final response = await get(
        Uri.parse(url),
        headers: {
