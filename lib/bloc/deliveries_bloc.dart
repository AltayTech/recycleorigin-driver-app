...
import 'package:recycleorigindriver/bloc/deliveries_event.dart';
...
import 'package:recycleorigindriver/models/request/delivery_main.dart';
  ...
  Future<void> _onSendRequest(
    ...
    try {
      if (event.isLogin) {
        ...
        final url =
            Urls.rootUrl + Urls.deliveriesEndPoint + '?store_id=${event.storeId}';
        await post(
          Uri.parse(url),
          headers: {
