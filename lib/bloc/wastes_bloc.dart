...
import 'package:recycleorigindriver/bloc/wastes_event.dart';
import 'package:recycleorigindriver/bloc/wastes_state.dart';
...
class WastesBloc extends Bloc<WastesEvent, WastesState> {
  ...
  set sPage(int value) =>
      add(WastesSearchParamsChanged(sPage: value));
  set sPerPage(int value) =>
      add(WastesSearchParamsChanged(sPerPage: value));
  set sOrder(String value) =>
      add(WastesSearchParamsChanged(sOrder: value));
  set sOrderBy(String value) =>
      add(WastesSearchParamsChanged(sOrderBy: value));
