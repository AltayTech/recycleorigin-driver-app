...
import 'package:recycleorigindriver/bloc/auth_event.dart';
import 'package:recycleorigindriver/bloc/auth_state.dart';
...
class AuthBloc extends Bloc<AuthEvent, AuthState> {
  ...
  Future<void> _onLoadToken(
    ...
    try {
      ...
      final loggedIn =
          await SecureStorage.getLoginStatus() && token.isNotEmpty;
