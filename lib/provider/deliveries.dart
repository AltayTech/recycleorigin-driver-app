...
//  }
  ...
  Future<void> searchCollectItems() async {
    ...
    final url = Urls.rootUrl + Urls.deliveriesEndPoint + '$searchEndPoint';
    print(url);
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        DeliveryMain deliveryMain = DeliveryMain.fromJson(extractedData);
        print(deliveryMain.searchDetail.max_page.toString());

        _deliveriesItems = deliveryMain.requestWasteItem;
